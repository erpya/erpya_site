...
export default function PortfolioGestionDeActivos() {
  return (
    <div className="pt-32 pb-24 min-h-screen">
      ...
      <div className="px-6 max-w-5xl mx-auto flex flex-col items-start gap-6">
        ...
        >
          ¿Cómo ayuda ADempiere a mejorar su Gestión de Activos?
        </motion.h1>
      ...
      <div className="w-full bg-muted/20 border-t border-border mt-12 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
            ...
            >
              <h3 className="text-2xl font-bold text-foreground border-b border-border w-full pb-4 mb-2">Gestión de Activos</h3>
              ...
              <ul className="mt-2 space-y-3 w-full">
                ...
                <li className="flex items-start gap-3 text-sm text-foreground">
                  ...
                  <span className="opacity-90 leading-relaxed">Mantener un maestro de Activos y relacionarlo a almacenamiento.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Configurar vida útil de Activo por agrupamiento.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Configurar depreciación.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Simulación de depreciaciones.</span>
                </li>
            ...
            <motion.div 
              ...
              className="glass-card p-8 flex flex-col items-start gap-4 hover:shadow-2xl transition-shadow border-t border-t-white/10"
            >
              <h3 className="text-2xl font-bold text-foreground border-b border-border w-full pb-4 mb-2">Mantenimiento de Activos Industriales</h3>
              ...
              <ul className="mt-2 space-y-3 w-full">
                ...
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Defina plantillas de Mantenimiento por tiempo o consumo.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Confeccione el Plan Maestro de Mantenimiento como elemento rector de su política de mantenimiento general.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Simule los mantenimientos por venir.</span>
                </li>
                
                
                <li className="flex items-start gap-3 text-sm text-foreground">
                  <CheckCircle2 className="text-primary mt-0.5 flex-shrink-0" size={16} />
                  <span className="opacity-90 leading-relaxed">Lance las órdenes de trabajo de forma coordinada y planificada.</span>
                </li>
      ...
      <div className="px-6 max-w-5xl mx-auto mt-20">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground">Conversemos sobre cómo adaptar <strong>¿Cómo ayuda ADempiere a mejorar su Gestión de Activos?</strong> a tus requerimientos.</p>
          </div>
